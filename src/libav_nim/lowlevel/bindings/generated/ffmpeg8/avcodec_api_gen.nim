...
proc av_packet_side_data_from_frame*(sd: ptr ptr AVPacketSideData;
                                     nb_sd: ptr cint;
                                     src: ptr struct_AVFrameSideData;
                                     flags: cuint): cint {.cdecl,
    importc: "av_packet_side_data_from_frame".}

proc av_packet_side_data_to_frame*(sd: ptr ptr ptr struct_AVFrameSideData;
                                   nb_sd: ptr cint; src: ptr AVPacketSideData;
                                   flags: cuint): cint {.cdecl,
    importc: "av_packet_side_data_to_frame".}
...
proc avcodec_receive_frame_flags*(avctx: ptr AVCodecContext; frame: ptr AVFrame;
                                  flags: cuint): cint {.cdecl,
    importc: "avcodec_receive_frame_flags".}
