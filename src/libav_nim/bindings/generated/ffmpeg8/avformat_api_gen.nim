...
proc avformat_send_command*(s: ptr AVFormatContext; id: enum_AVFormatCommandID;
    ...
    importc: "avformat_send_command".}

proc avformat_receive_command_reply*(s: ptr AVFormatContext;
                                     id: enum_AVFormatCommandID;
                                     data_out: ptr pointer): cint {.cdecl,
    importc: "avformat_receive_command_reply".}
